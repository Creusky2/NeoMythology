package com.mrcreusky.neomythology;
...
@Mod(NeoMythology.MODID)
public class NeoMythology
{
    ...
    // Creates a creative tab with the id "neomythology:example_tab" for the example item, that is placed after the combat tab
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.neomythology")) //The language key for the title of your CreativeModeTab
    ...
    public NeoMythology(IEventBus modEventBus, ModContainer modContainer)
    {
